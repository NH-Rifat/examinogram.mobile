...
import { Layout, ThemeColors } from '@/theme/theme';

export interface DropdownOption {
  label: string;
  value: string;
  style?: 'default' | 'buy' | 'sell';
}
      ...
      return (
        <TouchableOpacity
          style={[
            ...
            item.style === 'buy' && styles.buyOption,
            item.style === 'sell' && styles.sellOption,
          ]}
        ...
        >
          <Text
            style={[
              ...
              item.style === 'buy' && styles.buyText,
              item.style === 'sell' && styles.sellText,
            ]}
          >
            {item.label}
          </Text>
          {isSelected && <Ionicons name="checkmark" size={20} color={currentTheme.primary} />}
        </TouchableOpacity>
      );
    },
    [value, handleOptionSelect, styles, currentTheme.primary],
  );
